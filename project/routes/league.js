...
router.post("/createLeague", async(req, res, next) => {
    try {
        let team_assign = await league_utils.assign_matches(req.body.teams, req.body.policy)
        let new_league = league_utils.create_new_league(req.body.name, req.body.teams, req.body.policy, team_assign)
